<div class="container">
    ...
    <div class="container-fluid">
        <div class="row produto_title_table bg-dark text-light mb-1">
            ...
            <div class="col col-md-2 col-sm-2 col-xs-2 produto_title">ID</div>
        ...
        foreach ($rows as $row) {
            ...
            <div class="row">
                <div class="col col-md-2 col-sm-2 col-xs-2 produto_table pl-3 pt-1">
                    <i id="btnEdit" name="btnEdit" class="btn text-primary fa fa-edit" data-toggle="modal" data-target="#produtoModelForm" data-id="<?php echo $row['id']; ?>" data-produto="<?php echo $row['nome']; ?>" data-tipo="<?php echo $row['tipo']; ?>" data-quantidade="<?php echo $row['qtde']; ?>"></i>
