<div class="container">
    ...
    <h4 class="motorista_title">CADASTRO MOTORISTA</h4>

    <div class="row">
        <div class="col col-md-2 col-sm-2 col-xs-2">
            <span><input type="text" class="form-control w-100" placeholder="CPF" required=""></span>
        </div>
        <div class="col col-md-2 col-sm-2 col-xs-2">
            <input type="text" class="form-control w-100" placeholder="NOME" required="">
        </div>
        <div class="col col-md-2 col-sm-2 col-xs-2">
            <input type="text" class="form-control w-100" placeholder="NOME" required="">
        </div>
    ...
    <div class="container-fluid">
        <div class="row veiculo_title_table bg-dark text-light mb-1">
            ...
            <div class="col col-md-2 col-sm-2 col-xs-2 veiculo_title">CPF</div>
