        ...
        foreach ($rows as $row) {
            ...
            <div class="row">
                <div class="col col-md-2 col-sm-2 col-xs-2 cliente_table pl-3 pt-1">
                    <i id="btnEdit" name="btnEdit" class="btn text-primary fa fa-edit" data-toggle="modal" data-target="#clienteModelForm" data-id="<?php echo $row['id']; ?>" data-nome="<?php echo $row['nome']; ?>" data-cpf="<?php echo $row['cpf']; ?>" data-email="<?php echo $row['email']; ?>" data-telefone="<?php echo $row['telefone']; ?>" data-cep="<?php echo $row['cep']; ?>" data-logradouro="<?php echo $row['logradouro']; ?>" data-bairro="<?php echo $row['bairro']; ?>" data-cidade="<?php echo $row['cidade']; ?>" data-estado="<?php echo $row['estado']; ?>"></i>
