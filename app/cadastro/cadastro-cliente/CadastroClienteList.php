                                ...
                                foreach ($rows as $row) {
                                    ...
                                    <tr>
                                        <td class="project-actions text-left">
                                            <a class="btn btn-primary btn-xs text-white" href="" id="btnEdit" name="btnEdit" class="btn text-primary fa fa-edit" data-toggle="modal" data-target="#clienteModelForm" data-id="<?php echo $row['id']; ?>" data-nome="<?php echo $row['nome']; ?>" data-cpf="<?php echo $row['cpf']; ?>" data-email="<?php echo $row['email']; ?>" data-telefone="<?php echo $row['telefone']; ?>" data-cep="<?php echo $row['cep']; ?>" data-logradouro="<?php echo $row['logradouro']; ?>" data-bairro="<?php echo $row['bairro']; ?>" data-cidade="<?php echo $row['cidade']; ?>" data-estado="<?php echo $row['estado']; ?>">
                                                <i class="fas fa-pencil-alt fa-xs">
                                                </i>
                                            </a>
                                            <a class="btn btn-danger btn-xs text-white" href="" id="btnDel" name="btnDel" class="btn text-danger fa fa-trash" data-toggle="modal" data-target="#clienteModelDel" data-id="<?php echo $row['id']; ?>">
