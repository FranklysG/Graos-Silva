      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Cadastro Armazéns</h3>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Listagem de Armazéns</h3>
          </div>
          <!-- /.card-header -->
                ...
                foreach ($rows as $row) {
                  ...
                  <tr>
                    <td class="project-actions text-left">
                      <a class="btn btn-primary btn-xs text-white" href="" id="btnEdit" name="btnEdit" class="btn text-primary fa fa-edit" data-toggle="modal" data-target="#armazemModelForm" data-id="<?php echo $row['id']; ?>" data-nome="<?php echo $row['nome']; ?>" data-cnpj="<?php echo $row['cnpj']; ?>" data-logradouro="<?php echo $row['logradouro']; ?>" data-bairro="<?php echo $row['bairro']; ?>" data-cidade="<?php echo $row['cidade']; ?>" data-cep="<?php echo $row['cep']; ?>" data-estado="<?php echo $row['estado']; ?>">
                        <i class="fas fa-pencil-alt fa-xs">
                        </i>
                      </a>
                      <a class="btn btn-danger btn-xs text-white" href="" id="btnDel" name="btnDel" class="btn text-danger fa fa-trash" data-toggle="modal" data-target="#armazemModelDel" data-id="<?php echo $row['id']; ?>">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title veiculo_title" id="armazemModelFormLabel">NOVO ARMAZEM</h5>
